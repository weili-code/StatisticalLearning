...
<a href="https://weili-code.github.io/">
...
<a href="https://www.linkedin.com/in/wei-li-21580a301">
  <svg width="15" height="15" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M6.94 6.5C6.94 7.33 6.27 8 5.44 8C4.61 8 3.94 7.33 3.94 6.5C3.94 5.67 4.61 5 5.44 5C6.27 5 6.94 5.67 6.94 6.5ZM4.19 8.94H6.69V19H4.19V8.94ZM9.19 8.94H11.56V10.27H11.6C11.93 9.67 12.74 8.94 13.94 8.94C16.44 8.94 17 10.58 17 12.67V19H14.5V13.25C14.5 11.92 14.48 10.2 12.66 10.2C10.82 10.2 10.54 11.62 10.54 13.14V19H8.04V8.94H9.19Z" fill="black"/>
  </svg>
</a>
<a href="mailto:weili-code2026@outlook.com">
  <svg width="15" height="15" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
with a focus on fundamental concepts and ideas in predictive modeling, model evaluation, 
and modern learning methods.

It emphasizes statistical principles for inference and uncertainty quantification, 
providing a conceptual foundation for understanding and developing reliable 
and interpretable machine learning systems.


### 0. Overview
- [Overview](Lecture/0_overview_slides.pdf)


### 1. Linear Models
- [Linear Regression](Lecture/1_linearReg_slides.pdf)

### 2. Model Evaluation
- [Error, Bias–Variance Tradeoff, and Validation](Lecture/2_error_validation_slides.pdf)
- [Model Assessment](Lecture/7_modelassessment_slides.pdf)

### 3. Regularization
- [Regularization Methods](Lecture/3_regularization_slides.pdf)


### 4. Classification
- [Classification Methods](Lecture/4_classification_slides.pdf)


### 5. Nonparametric Methods
- [Nonparametric Methods I](Lecture/6a_nonparametrics_slides.pdf)
- [Nonparametric Methods II](Lecture/6b_nonparametrics_slides.pdf)
- [Nonparametric Methods III](Lecture/6c_nonparametrics_slides.pdf)


### 6. Resampling Methods
- [Bootstrap](Lecture/8_bootstrap_slides.pdf)


### 7. Model Averaging and Ensemble Methods
- [Model Averaging and Bagging](Lecture/9_modelAvg_bagging_slides.pdf)


### 8. Tree-Based Methods
- [Decision Trees](Lecture/10a_trees_slides.pdf)
- [MARS and HME](Lecture/10b_mars_hme_slides.pdf)

### 9. Ensemble Methods
- [Random Forests](Lecture/11_randomForest_slides.pdf)
- [Boosting Methods I](Lecture/12a_boostedTrees_slides.pdf)
- [Boosting Methods II](Lecture/12b_boostedTrees_slides.pdf)

### 10. Neural Networks
- [Neural Networks I](Lecture/13a_NeuralNetworks_slides.pdf)
- [Neural Networks II](Lecture/13b_NeuralNetworks_slides.pdf)